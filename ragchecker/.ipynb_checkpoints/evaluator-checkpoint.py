...
class RAGChecker():
    ...
    def __init__(
        ...
        extractor_max_new_tokens=1200,  # 日本語処理用に増加
        extractor_api_base=None,
        checker_api_base=None,
        #batch_size_extractor=32,
        batch_size_extractor=16,        # 日本語処理効率を考慮
        #batch_size_checker=32,
        batch_size_checker=16,          # 日本語処理効率を考慮
        openai_api_key=None,
        joint_check=True,
        joint_check_num=5,
        ...
        **kwargs
        ...
        if checker_name == "nli":
            ...
            self.checker = NLIChecker(model='cyberagent/xlm-roberta-large-jnli-jsick',
                                      device=0,
