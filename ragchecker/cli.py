...
def get_args():
    ...
    #)
    parser.add_argument(
        '--extractor_max_new_tokens', type=int, default=1200,
        help="Max generated tokens of the extractor, set a larger value for longer documents. Default: 1000"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="Batch size for extractor (optimized for Japanese processing)."
    )
    parser.add_argument(
        "--batch_size_checker", type=int, default=16,
        help="Batch size for checker (optimized for Japanese processing)."
    )
    # checking options
    parser.add_argument(
